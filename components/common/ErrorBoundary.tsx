                    ...
                    <div className="relative z-10 max-w-lg w-full text-center space-y-8 animate-in fade-in zoom-in duration-500">
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <button
                                ...
                                className="group relative px-6 py-2 bg-gray-800 hover:bg-gray-700 text-gray-300 font-bold uppercase tracking-wider text-sm rounded-lg transition-all flex items-center justify-center gap-2 mx-auto border border-gray-700"
                            >
                                <span>⚠️ Clear All Data & Reset</span>
                            </button>
                        </div>
