        ...
        >
            ...
            <div className="flex items-center gap-3">
                ...
                <button
                    ...
                    className={`
                        w-12 h-12 rounded-xl flex items-center justify-center border transition-all duration-200 touch-manipulation
                        ${!canComplete
                            ? 'bg-slate-900/50 border-slate-800 text-slate-700 cursor-not-allowed'
                            : 'bg-blue-600/10 border-blue-500/50 text-blue-400 hover:bg-blue-600 hover:text-white hover:shadow-[0_0_15px_rgba(37,99,235,0.4)] active:scale-95'
                        }
                    `}
                >
                    {isCompletedToday ? (
                        ...
                        <Sword size={20} className={canComplete ? "group-hover:scale-110 transition-transform" : ""} />
                    )}
                </button>
            </div>
        </motion.div>
