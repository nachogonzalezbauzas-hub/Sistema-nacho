...
const DROP_RATE_INFO = [
    ...
    { rarity: 'Transcendent', color: '#fffacd', unlockFloor: 100, baseRate: '0.1% → 2%' },
    // Legacy High-Tier (The "Big Five" before Zones)
    { rarity: 'Primordial', color: '#f59e0b', unlockFloor: 125, baseRate: '0.09% → 1.8%' },
    { rarity: 'Eternal', color: '#10b981', unlockFloor: 135, baseRate: '0.08% → 1.6%' },
    { rarity: 'Divine', color: '#fcd34d', unlockFloor: 145, baseRate: '0.07% → 1.4%' },
    { rarity: 'Cosmic', color: '#6366f1', unlockFloor: 155, baseRate: '0.06% → 1.2%' },
    { rarity: 'Infinite', color: '#ffffff', unlockFloor: 165, baseRate: '0.05% → 1.0%' },
    // Zone Rarities (High Tier)
    { rarity: 'Magma', color: '#ef4444', unlockFloor: 175, baseRate: '0.05% → 1%' },
    { rarity: 'Abyssal', color: '#06b6d4', unlockFloor: 200, baseRate: '0.04% → 0.9%' },
    { rarity: 'Verdant', color: '#22c55e', unlockFloor: 225, baseRate: '0.03% → 0.8%' },
    { rarity: 'Storm', color: '#a855f7', unlockFloor: 250, baseRate: '0.02% → 0.7%' },
    { rarity: 'Lunar', color: '#cbd5e1', unlockFloor: 250, baseRate: '0.01% → 0.6%' },
    { rarity: 'Solar', color: '#fbbf24', unlockFloor: 270, baseRate: '0.01% → 0.5%' },
    { rarity: 'Nebula', color: '#e879f9', unlockFloor: 290, baseRate: '0.009% → 0.4%' },
    { rarity: 'Singularity', color: '#8b5cf6', unlockFloor: 310, baseRate: '0.008% → 0.3%' },
    { rarity: 'Nova', color: '#fb7185', unlockFloor: 330, baseRate: '0.007% → 0.2%' },
    { rarity: 'Cyber', color: '#34d399', unlockFloor: 350, baseRate: '0.006% → 0.15%' },
    { rarity: 'Crystal', color: '#5eead4', unlockFloor: 370, baseRate: '0.005% → 0.12%' },
    { rarity: 'Ethereal', color: '#7dd3fc', unlockFloor: 390, baseRate: '0.004% → 0.1%' },
    { rarity: 'Crimson', color: '#ef4444', unlockFloor: 410, baseRate: '0.003% → 0.09%' },
    { rarity: 'Heavenly', color: '#fef08a', unlockFloor: 430, baseRate: '0.002% → 0.08%' },
    { rarity: 'Antimatter', color: '#ffffff', unlockFloor: 450, baseRate: '0.001% → 0.07%' },
    { rarity: 'Temporal', color: '#fb923c', unlockFloor: 470, baseRate: '0.0009% → 0.06%' },
    { rarity: 'Chaotic', color: '#ec4899', unlockFloor: 490, baseRate: '0.0008% → 0.05%' },
    { rarity: 'Void', color: '#6b7280', unlockFloor: 510, baseRate: '0.0005% → 0.04%' },
    { rarity: 'Omega', color: '#6366f1', unlockFloor: 550, baseRate: '0.0001% → 0.01%' },
];
