...
import { Dumbbell, Heart, Zap, Brain, DollarSign, Flame, Activity } from 'lucide-react';
...
export const StatIcon: React.FC<{ stat: StatType; size?: number; className?: string }> = ({ stat, size = 20, className = "" }) => {
    ...
    let color = "";
    switch (stat) {
        case 'Strength': animClass = "animate-pulse-fast"; color = "text-cyan-400 drop-shadow-[0_0_8px_rgba(34,211,238,0.8)]"; return <Dumbbell size={size} className={`${className} ${animClass} ${color}`} />;
        case 'Vitality': animClass = "animate-pulse-slow"; color = "text-red-500 drop-shadow-[0_0_8px_rgba(239,68,68,0.8)]"; return <Heart size={size} className={`${className} ${animClass} ${color}`} />;
        ...
        case 'Intelligence': animClass = "animate-float"; color = "text-purple-400 drop-shadow-[0_0_8px_rgba(192,132,252,0.8)]"; return <Brain size={size} className={`${className} ${animClass} ${color}`} />;
        case 'Fortune': animClass = "animate-shimmer"; color = "text-green-400 drop-shadow-[0_0_8px_rgba(74,222,128,0.8)]"; return <DollarSign size={size} className={`${className} ${animClass} ${color}`} />;
        case 'Metabolism': animClass = "animate-pulse"; color = "text-blue-400 drop-shadow-[0_0_8px_rgba(96,165,250,0.8)]"; return <Flame size={size} className={`${className} ${animClass} ${color}`} />;
