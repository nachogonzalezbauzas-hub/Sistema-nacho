            ...
            {frames.map(frame => {
                ...
                switch (frame.id) {
                    ...
                    case 'eternal_chain':
                        ...
                        break;
                    case 'blue_flame':
                        miniFrameStyle = "border-blue-500 shadow-[0_0_8px_rgba(59,130,246,0.6)]";
                    ...
                    case 'golden_glory':
                        ...
                        miniEffect = <div className="absolute inset-[-2px] border border-yellow-300/40 rounded-full animate-spin-slow"></div>;
                        break;
                    case 'monarch_aura':
                        miniFrameStyle = "border-black shadow-[0_0_15px_rgba(0,0,0,0.8)] bg-black";
                        miniEffect = <div className="absolute inset-[-3px] bg-gradient-to-r from-purple-900/40 to-blue-900/40 rounded-full animate-pulse -z-10"></div>;
                        break;
                    case 'season_crest':
                        miniFrameStyle = "border-indigo-400 shadow-[0_0_8px_rgba(129,140,248,0.6)]";
                        miniEffect = <div className="absolute inset-[-2px] border border-indigo-300/30 rounded-full animate-pulse"></div>;
                        break;
                    case 'goblin_frame':
                        miniFrameStyle = "border-green-700 shadow-[0_0_5px_rgba(21,128,61,0.5)] bg-green-950";
                        break;
                    case 'insect_carapace':
                        miniFrameStyle = "border-amber-700 shadow-[0_0_5px_rgba(180,83,9,0.5)] bg-amber-950";
                        break;
                    case 'red_gate_frost':
                        miniFrameStyle = "border-sky-300 shadow-[0_0_8px_rgba(125,211,252,0.6)] bg-sky-950";
                        miniEffect = <div className="absolute inset-0 bg-sky-400/10 animate-pulse"></div>;
                        break;
                    case 'orc_tusk':
                        miniFrameStyle = "border-red-800 shadow-[0_0_8px_rgba(153,27,27,0.6)] bg-red-950";
                        break;
                    case 'ant_king_crown':
                        miniFrameStyle = "border-purple-900 shadow-[0_0_10px_rgba(88,28,135,0.7)] bg-black";
                        miniEffect = <div className="absolute inset-[-2px] border border-purple-700/40 rounded-full animate-pulse"></div>;
                        break;
                    case 'god_statue_aura':
                        miniFrameStyle = "border-rose-600 shadow-[0_0_12px_rgba(225,29,72,0.8)] bg-black";
                        miniEffect = <div className="absolute inset-[-3px] bg-gradient-to-r from-rose-900/30 to-black rounded-full animate-pulse -z-10"></div>;
                        break;
                    default:
