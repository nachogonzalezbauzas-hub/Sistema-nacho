...
export const ActionModules: React.FC<ActionModulesProps> = ({ canOpenChest, onOpenChest, season, seasonProgress, onOpenSeason }) => {
    return (
            ...
            {season && (
                ...
                >
                    ...
                    <div className="relative z-10 flex items-center h-full px-6 gap-6">
                        ...
                        <div className="text-left">
                            <div className="text-xs font-bold text-blue-400 uppercase tracking-[0.2em] mb-1">Current Season</div>
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-[10px] font-mono text-blue-300">RANK {seasonProgress?.rank || 'E'}</span>
                            </div>
                        </div>
                    </div>
                </button>
