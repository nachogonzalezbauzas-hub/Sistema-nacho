...
export const ShadowCommand: React.FC<ShadowCommandProps> = ({ equippedShadow }) => {
    const pulseVariant = {
        animate: {
            opacity: [0.3, 0.6, 0.3],
            scale: [1, 1.02, 1],
            ...
            <div className="relative border-2 border-purple-500/50 bg-[#05020a] overflow-hidden">
                ...
                <div className="relative p-6 flex flex-col md:flex-row items-center gap-6 z-10">
                    ...
                    <div className="flex-1 text-center md:text-left">
                        <div className="text-xs font-bold text-purple-400 uppercase tracking-[0.3em] mb-1 animate-pulse">Shadow Marshal</div>
                        ...
                        <div className="flex items-center justify-center md:justify-start gap-4 mt-2">
                            <span className="bg-purple-900/50 border border-purple-500/50 px-2 py-0.5 text-xs font-mono text-purple-200">
                                RANK: {equippedShadow.rank}
                            </span>
                            <span className="bg-purple-900/50 border border-purple-500/50 px-2 py-0.5 text-xs font-mono text-purple-200">
                                BONUS: +{equippedShadow.bonus.value} {equippedShadow.bonus.stat}
                            </span>
                        </div>
                    </div>
                </div>
