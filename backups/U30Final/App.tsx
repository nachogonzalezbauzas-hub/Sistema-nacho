  ...
  const renderContent = () => {
    switch (currentTab) {
      ...
      case 'Misiones':
        ...
        />;
      case 'Logs': return <LogsView logs={state.logs} stats={state.stats} activeBuffs={state.activeBuffs} />;
      case 'Físico': return <BodyView records={state.bodyRecords} onAddRecord={addBodyRecord} healthSummary={state.healthSummary} />;
      case 'Logros': return <AchievementsView state={state} onEquipTitle={equipTitle} />;
      ...
      case 'Shadows': return <ShadowsView state={state} onEquipShadow={equipShadow} />;
      case 'PowerAnalysis': return <PowerAnalysisView state={state} onBack={() => setCurrentTab('Dashboard')} />;
      case 'Shop': return <QuestShop />;
      case 'Gear': return <GearView state={state} onEquip={equipItem} onUnequip={unequipItem} onUpgrade={upgradeItem} onSalvage={salvageItem} onAddEquipment={addEquipment} />;
      case 'Dungeons': return <DungeonsView state={state} />;
      case 'JobChange': return <JobChangeView state={state} onJobChange={() => { }} />;
      default: return <DashboardView state={state} onAddMission={addMission} onCompleteMission={handleMissionCompletion} onAddBodyRecord={addBodyRecord} onOpenChest={openDailyChest} canOpenChest={canOpenDailyChest()} onClaimQuestReward={claimQuestReward} />;
    }
  };
