...
export const GearView: React.FC<GearViewProps> = ({ state, onEquip, onUnequip, onUpgrade, onSalvage, onAddEquipment }) => {
                ...
                <div className="flex-1 overflow-y-auto space-y-6">
                    ...
                    <div className="relative h-[400px] bg-[#050a14] rounded-2xl border border-slate-800 p-4 flex items-center justify-center">
                        ...
                        <div className="absolute bottom-4 left-4 text-[10px] text-slate-500 font-mono">
                            <div className="font-bold text-slate-300 mb-1">TOTAL BONUS</div>
                    ...
                    {/* Set Bonuses */}
                    <div>
                        <h3 className="text-sm font-bold text-slate-400 uppercase mb-3">Active Set Bonuses</h3>
                ...
                <div className="flex-1 overflow-y-auto">
                    ...
                    {inventoryItems.length === 0 && (
                        <div className="text-center py-12 opacity-50">
                            ...
                            <p className="text-slate-500 font-mono text-xs">Inventory is empty.</p>
                        </div>
                    )}
                        ...
                        >
                            ...
                            {getEquippedItem(selectedSlot) ? (
                                ...
                                <div className="text-center py-8">
                                    ...
                                    <p className="text-slate-400 text-sm mb-4">No item equipped in this slot.</p>
                                    <button
                                        onClick={() => {
