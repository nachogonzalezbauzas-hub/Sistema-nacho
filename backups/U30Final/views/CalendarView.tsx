        ...
        <div className="pb-24 space-y-6 animate-in fade-in slide-in-from-bottom-8 duration-700">
            ...
            <div className="grid grid-cols-4 gap-2 p-2 bg-slate-900/50 rounded-xl border border-blue-900/30 backdrop-blur-md">
                <div className="flex flex-col items-center p-2 bg-slate-950/50 rounded-lg border border-slate-800">
                    <span className="text-[9px] text-slate-500 font-bold uppercase tracking-wider">Weekly XP</span>
                ...
                <div className="flex flex-col items-center p-2 bg-slate-950/50 rounded-lg border border-slate-800">
                    <span className="text-[9px] text-slate-500 font-bold uppercase tracking-wider">Avg Sleep</span>
                    <span className="text-lg font-black text-purple-400 font-mono">{weeklySummary.avgSleep}h</span>
                </div>
                <div className="flex flex-col items-center p-2 bg-slate-950/50 rounded-lg border border-slate-800">
                    <span className="text-[9px] text-slate-500 font-bold uppercase tracking-wider">Avg Weight</span>
                    ...
                    >
                        <div className="sticky top-0 bg-[#030712]/95 backdrop-blur-md p-4 border-b border-blue-900/30 flex justify-between items-center z-10">
                            <div className="flex flex-col">
                                <span className="text-xs font-bold text-blue-500 uppercase tracking-widest">System Log</span>
                        ...
                        <div className="p-6 space-y-6 pb-24">
                            ...
                            <div className="grid grid-cols-3 gap-3">
                                <div className="bg-slate-900/50 p-3 rounded-lg border border-slate-800 flex flex-col items-center">
                                    <span className="text-[10px] text-slate-500 uppercase tracking-wider mb-1">XP Gained</span>
                                    <span className="text-xl font-black text-blue-400 font-mono">+{selectedDayData.xpGained}</span>
                                </div>
                                <div className="bg-slate-900/50 p-3 rounded-lg border border-slate-800 flex flex-col items-center">
                                    <span className="text-[10px] text-slate-500 uppercase tracking-wider mb-1">Streak</span>
                                    <div className="flex items-center gap-1 text-orange-400 font-bold">
                                        <Flame size={14} /> {selectedDayData.streak || '-'}
                                    </div>
                                </div>
                                <div className="bg-slate-900/50 p-3 rounded-lg border border-slate-800 flex flex-col items-center">
                                    <span className="text-[10px] text-slate-500 uppercase tracking-wider mb-1">Efficiency</span>
                            ...
                            {selectedDayData.health ? (
                                <div className="bg-slate-900/30 p-4 rounded-lg border border-purple-900/30">
                                    <div className="flex items-center gap-2 mb-3">
                                        ...
                                        <h3 className="text-sm font-bold text-purple-200 uppercase tracking-wider">Physical Status</h3>
                                    </div>
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            <span className="text-[10px] text-slate-500 block mb-1">WEIGHT</span>
                                            <span className="text-lg font-mono font-bold text-white">{selectedDayData.health.weight} kg</span>
                                        </div>
                                        <div>
                                            <span className="text-[10px] text-slate-500 block mb-1">SLEEP</span>
                                ...
                                <div className="p-4 rounded-lg border border-slate-800 border-dashed text-center">
                                    <span className="text-xs text-slate-600 uppercase tracking-wider">No physical data recorded</span>
                                </div>
                            )}
                            ...
                            <div className="space-y-2 max-h-60 overflow-y-auto pr-1 custom-scrollbar">
                                {selectedDayData.logs && selectedDayData.logs.length > 0 ? (
                                    ...
                                    <p className="text-xs text-slate-500 italic text-center py-4">No activity logs for this day.</p>
                                )}
                            </div>
                            ...
                            {selectedDayData.journal && selectedDayData.journal.length > 0 && (
                                <div className="space-y-3">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <h3 className="text-sm font-bold text-slate-200 uppercase tracking-wider">Journal Entries</h3>
                                    </div>
