...
export const StatIcon: React.FC<{ stat: StatType; size?: number; className?: string }> = ({ stat, size = 20, className = "" }) => {
    ...
    switch (stat) {
        ...
        case 'Fortune': animClass = "animate-shimmer"; color = "text-purple-400 drop-shadow-[0_0_8px_rgba(192,132,252,0.8)]"; return <Crown size={size} className={`${className} ${animClass} ${color}`} />;
