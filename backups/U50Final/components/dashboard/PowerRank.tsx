...
export const POWER_RANKS = [
    ...
    // Tier 51-62: Celestial (Cyan → White → Cosmic)
    // Inspired by the "Mystic" aesthetic: Dark background, Cyan/Purple glow, Stars
    { rank: 51, name: 'Celestial I', min: 1020000, hex: '#22d3ee', glow: 'shadow-[0_0_60px_rgba(34,211,238,0.4)]', shimmer: true, rainbow: false, celestial: true },
    { rank: 52, name: 'Celestial II', min: 1040000, hex: '#06b6d4', glow: 'shadow-[0_0_65px_rgba(6,182,212,0.45)]', shimmer: true, rainbow: false, celestial: true },
    { rank: 53, name: 'Celestial III', min: 1060000, hex: '#0891b2', glow: 'shadow-[0_0_70px_rgba(8,145,178,0.5)]', shimmer: true, rainbow: false, celestial: true },
    { rank: 54, name: 'Celestial IV', min: 1080000, hex: '#0ea5e9', glow: 'shadow-[0_0_75px_rgba(14,165,233,0.55)]', shimmer: true, rainbow: false, celestial: true },
    { rank: 55, name: 'Celestial V', min: 1100000, hex: '#38bdf8', glow: 'shadow-[0_0_80px_rgba(56,189,248,0.6)]', shimmer: true, rainbow: false, celestial: true },

    { rank: 56, name: 'Divine I', min: 1120000, hex: '#e0f2fe', glow: 'shadow-[0_0_70px_rgba(224,242,254,0.6)]', shimmer: true, rainbow: false, celestial: true },
    { rank: 57, name: 'Divine II', min: 1140000, hex: '#c084fc', glow: 'shadow-[0_0_75px_rgba(192,132,252,0.65)]', shimmer: true, rainbow: false, celestial: true }, // Purple tint
    { rank: 58, name: 'Divine III', min: 1160000, hex: '#a855f7', glow: 'shadow-[0_0_80px_rgba(168,85,247,0.7)]', shimmer: true, rainbow: false, celestial: true },
    { rank: 59, name: 'Divine IV', min: 1180000, hex: '#d8b4fe', glow: 'shadow-[0_0_85px_rgba(216,180,254,0.75)]', shimmer: true, rainbow: false, celestial: true },
    { rank: 60, name: 'Divine V', min: 1200000, hex: '#f0abfc', glow: 'shadow-[0_0_90px_rgba(240,171,252,0.8)]', shimmer: true, rainbow: false, celestial: true },

    { rank: 61, name: 'Transcendent', min: 1225000, hex: '#ffffff', glow: 'shadow-[0_0_100px_rgba(34,211,238,0.8)]', shimmer: true, rainbow: false, celestial: true },
    // FINAL RANK: 1.25M - Unique "Cosmic" Animation
    { rank: 62, name: 'Absolute Being', min: 1250000, hex: '#ffffff', glow: 'shadow-[0_0_120px_rgba(34,211,238,1),0_0_200px_rgba(168,85,247,0.8)]', shimmer: false, rainbow: false, celestial: true, cosmic: true },
];
...
export const PowerRankBadge: React.FC<PowerRankBadgeProps> = ({
    ...
    const rankData = getPowerRank(power) as any;
    ...
    return (
        <>
            <style>{`
                ...
                @keyframes power-celestial {
                    0% { text-shadow: 0 0 10px rgba(34,211,238,0.5); }
                    50% { text-shadow: 0 0 25px rgba(255,255,255,0.9), 0 0 40px rgba(34,211,238,0.7); }
                    100% { text-shadow: 0 0 10px rgba(34,211,238,0.5); }
                }
                @keyframes power-cosmic {
                ...
                .bg-cosmic {
                    ...
                    animation: power-cosmic 3s linear infinite;
                }
            `}</style>
            ...
            `}>
                ...
                >
                    ...
                    <div className="relative z-10 flex flex-col">
                        ...
                        <div
                            className={`font-bold tracking-wider ${size === 'lg' ? 'text-xl' : size === 'md' ? 'text-base' : 'text-sm'} ${rankData.cosmic ? 'bg-cosmic' : ''}`}
                            style={rankData.rainbow ? {
                                ...
                                color: rankData.hex,
                                animation: 'power-celestial 3s ease-in-out infinite',
                            } : {
                                color: rankData.hex,
