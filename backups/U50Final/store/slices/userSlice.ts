...
export const createUserSlice: StateCreator<GameStore, [], [], UserSlice> = (set, get) => ({
    ...
    setJobClass: (jobClass) => {
        set((store) => {
            const log = createLog('System', 'Job Change', `Awakened as: ${jobClass}`);
            return {
                state: {
                    ...store.state,
                    ...
                    rewardQueue: [
                        ...store.state.rewardQueue,
                        {
                            ...
                            type: 'title' as const,
                            name: `Class: ${jobClass}`,
                            description: `You have awakened as a ${jobClass}!`,
                            icon: '⚔️',
    ...
    importProceduralTitle: (title) => {
        set((store) => {
            ...
            const log = createLog('System', 'Title Imported', `Imported procedural title: ${title.name}`);
    ...
    importProceduralFrame: (frame) => {
        set((store) => {
            ...
            const log = createLog('System', 'Frame Imported', `Imported procedural frame: ${frame.name}`);
