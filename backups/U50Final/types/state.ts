...
import { Mission, JournalEntry, Milestone, SeasonDefinition, SeasonProgress, DungeonRunResult, DailyQuest, RewardItem, CalendarDayData } from './features';
...
export interface AppState {
    ...
    // Monarch's Domain
    monarchDomain?: import('./domain').MonarchDomain;
}
