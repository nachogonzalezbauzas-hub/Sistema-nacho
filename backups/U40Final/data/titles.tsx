...
const BASE_TITLES: TitleDefinition[] = [
...
const BASE_FRAMES: FrameDefinition[] = [
...
import { SHOP_TITLES, SHOP_FRAMES } from './shopCosmetics';
...
export const TITLES: TitleDefinition[] = [...BASE_TITLES, ...SHOP_TITLES].sort((a, b) => {
  return (TITLE_RARITY_ORDER[a.rarity] || 0) - (TITLE_RARITY_ORDER[b.rarity] || 0);
});

export const AVATAR_FRAMES: FrameDefinition[] = [...BASE_FRAMES, ...SHOP_FRAMES].sort((a, b) => {
